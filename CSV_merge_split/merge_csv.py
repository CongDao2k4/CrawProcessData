...
# def get_list_file_by_os(input_dir = 'data_merged'):
#     file_paths = set()
...
def append_to_csv(csv_file_child_path, csv_file_parent='vnese_new.csv', output_dir='data_merged'):
...
def merge_all_csv_files():
    ...
    print("\n=== HOÀN THÀNH ===")
    print(f"Đã gộp {len(csv_file_child_paths)} file vào .csv")
